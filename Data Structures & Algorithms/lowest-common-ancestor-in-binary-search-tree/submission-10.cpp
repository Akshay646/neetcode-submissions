...
public:
    ...
    TreeNode* lowestCommonAncestor(TreeNode* root, TreeNode* p, TreeNode* q) {
        ...
        //Because we're comparing from the root backwards, not from the node.
        //The vectors are stored like this: [node ... root]. So the last element is always the root.
        //So the last matching element is the lca
